...
After integrating all results from 3 different tools, we narrowed the features down to these list.\\
\begin{center}
StartingBidPercent\\
SellerClosePercent\\
StartingBid\\
...
In all three tools here, we tried to use different type of classification algorithms to 
